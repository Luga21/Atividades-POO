/**
 * @author Luga21
 * Criação de um tabuleiro com n linhas por m colunas. Esse tabuleiro é
 * preenchido com cinco letras (informadas pelo usuário) distribuídas aleatoriamente no vetor.
 */
